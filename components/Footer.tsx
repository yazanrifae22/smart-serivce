        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="text-lg leading-relaxed mb-10 font-medium">
              Elite document clearance and regulatory consultancy in the UAE. We bridge the gap
              between businesses and authorities.
            </p>
            <div className="flex space-x-5">
              <a
                href="#"
                className="p-3 bg-white/5 rounded-xl hover:bg-sky-600 hover:text-white transition-all"
              >
                <Linkedin size={22} />
              </a>
              <a
          ...
          <div>
            <h4 className="text-white font-black uppercase tracking-widest text-sm mb-10">
              Specialized Services
            </h4>
            <ul className="space-y-5 text-lg font-bold">
              <li>
                <a href="#healthcare" className="hover:text-sky-400 transition-colors">
                  Healthcare Licensing
                </a>
              </li>
              <li>
                <a href="#formation" className="hover:text-sky-400 transition-colors">
                  Mainland Setup
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#govt" className="hover:text-sky-400 transition-colors">
                  Employee Visas
                </a>
              </li>
              <li>
                <a href="#govt" className="hover:text-sky-400 transition-colors">
                  Annual PRO Contracts
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-5 text-lg font-bold">
              ...
              <li>
                <a href="#whyus" className="hover:text-sky-400 transition-colors">
                  Our Advantage
                </a>
              </li>
              <li>
                <a href="#consultation" className="hover:text-sky-400 transition-colors">
                  Book Advisory
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-6 text-lg font-bold">
              ...
              <li className="flex items-center space-x-4 group">
                ...
                <span className="group-hover:text-white transition-colors">+971552416515</span>
              </li>
              <li className="flex items-center space-x-4 group">
                <Mail size={24} className="text-sky-500 flex-shrink-0" />
                <span className="group-hover:text-white transition-colors">
                  info@smartsserivce.com
                </span>
              </li>
            </ul>
          </div>
